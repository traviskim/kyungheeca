      ...
      <div class="navbar pink navbar-default yamm">
        ...
        <div id="navbar-collapse-grid" class="navbar-collapse collapse pull-right">
          <ul class="nav pink navbar-nav">
            ...
            <li><a href="cares.html" class="dropdown-toggle active">Our Cares</a></li>
 ...
 <section>
    <div class="header-inner two">
      <div class="inner text-center">
        <h4 class="title text-white uppercase">Cares And tips</h4>
      ...
      <div class="row no-gutter">
        ...
        <div class="col-md-6">
          <div class="text-box padding-left-5">
           <h5 class="raleway">Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Suspendisse et justo. </h5>
          ...
          <br/>
          <a class="btn btn-pink btn-xround" href="#">Read more</a>
          </div>
        </div>
        <!--end item-->
    ...
    <div class="container">
      ...
      <div class="row no-gutter sec-padding">
         <div class="col-xs-12 text-center">
          <h2 class=" raleway">Ask Our Experts</h2>
