<?php
	...
	--------------------------------------------- */
	$receiver_name = "KYUNG HEE ACUPUNCTURE";
	...
	------------------------------------------------------ */
	$receiver_email = "LTEDOC@GMAIL.COM";
	...
	----------------------------------------------------------------------------- */	
	$redirectForm = false;
	$redirectForm_url = "http://kyungheeca.com/thankyou.php";
	
	/* Powered BY
	 * You will use both your website NAME and URL
	 * By default its powered by SMARTFORMS - http://www.doptiq.com/smart-forms
	----------------------------------------------------------------------------- */
	$poweredby_name = "KYUNG HEE ACUPUNCTURE";
	$poweredby_url = "http://kyungheeca.com";	
